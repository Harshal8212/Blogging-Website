...
<div class="header">
        ...
        <div class="container">
            <div class="row">
                <div class="d-flex flex-column">
                    ...
                    <div class="p-2"><h2>Entertainment Blogs</h2></div>
                    <div class="p-2"><button class="btn btn-primary"><a href="./add_en.php?id=<?=$uid?>" >ADD BLOG</a></button></div>
                  </div>
    ...
    <section class="blog-page">
        <div class="container">
            ...
            <?php 
                $sql = "SELECT * FROM enblog ORDER BY id DESC";
